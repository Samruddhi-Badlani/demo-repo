...
router.get("/getState", checkAuthenticated, (req, res) => {
    // flash sets a messages variable. passport sets the error message
    console.log(req.session.flash.error);

    pool.query('SLECT * FROM states',(err,res)=>{
        states = res.rows;
    })

    res.render("state.ejs",{states:states});
  });

  router.post("/postState", checkAuthenticated, (req, res) => {
    // flash sets a messages variable. passport sets the error message
    console.log(req.session.flash.error);

    pool.query('SELECT * FROM states',(err,res)=>{
        states = res.rows;
    })
